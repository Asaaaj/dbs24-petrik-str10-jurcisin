...
#docker build -t dbs24-petrik-str10-jurcisin . 
...
#druhe zadanie
#docker run -p 127.0.0.1:8000:8000 --env DATABASE_HOST=host.docker.internal --env DATABASE_PORT=5432 --env DATABASE_NAME=superuser --env DATABASE_USER=postgres --env DATABASE_PASSWORD=7355608 --name dbs24-petrik-str10-jurcisin-container dbs24-petrik-str10-jurcisin